...
#
# **Lazy Evaluation** bedeutet, dass Berechnungen erst dann durchgeführt werden, wenn sie benötigt werden. Generatoren ermöglichen uns, dieses Konzept in Python zu nutzen.

# %% [markdown]
# **Beispiel mit unendlicher Folge:**
...
# **Erläuterung:**
#
# - Die Funktion `infinite_sequence` erzeugt eine unendliche Zahlenfolge.
...
# %% [markdown]
# ## Weiterführende Beispiele und Übungen
#
# 1. **Implementiere einen Generator, der die Fibonacci-Folge erzeugt.**
...
# Ausgabe der ersten 10 Fibonacci-Zahlen
for _ in range(10):
    print(next(fib_gen), end=" ")
print()

# %% [markdown]
# 2. **Vergleiche den Speicherbedarf einer Generator Expression mit der entsprechenden List Comprehension für eine große Sequenz.**

# %%
large_list_comp = [i for i in range(1000000)]
large_gen_expr = (i for i in range(1000000))

print("Größe der List Comprehension:", getsizeof(large_list_comp), "Bytes")
print("Größe der Generator Expression:", getsizeof(large_gen_expr), "Bytes")

# %% [markdown]
# **Erläuterung:**
#
# Die List Comprehension benötigt viel Speicher, um alle Elemente zu speichern, während die Generator Expression nur einen kleinen konstanten Speicherbedarf hat.
